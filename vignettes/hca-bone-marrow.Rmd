---
title: "HCA human bone marrow (10X Genomics)"
...
output:
  rmarkdown::html_document:
    ...
    fig_width: 5
vignette: >
  %\VignetteIndexEntry{hca-bone-marrow}
...
This is a fairly big dataset that represents a good use case for the techniques in, as discussed in the book [Advanced Single-Cell Analysis with Bioconductor](https://bioconductor.org/books/3.16/OSCA.advanced/dealing-with-big-data.html).

## Data loading

This dataset is loaded via the [HCAData](https://bioconductor.org/packages/3.16/data/experiment/html/HCAData.html) package, which provides a ready-to-use `SingleCellExperiment` object. 
